...
export default function ConsultationPage() {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <section className="relative min-h-[44vh] flex items-center justify-center bg-teal-700 pt-24 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 right-1/4 w-96 h-96 bg-teal-500/30 rounded-full blur-[120px]" />
          <div className="absolute bottom-0 left-1/4 w-80 h-80 bg-white/10 rounded-full blur-[100px]" />
        </div>
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 text-center py-16">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7 }}
          >
            <span className="inline-flex items-center gap-2 bg-white/20 border border-white/30 text-white text-sm font-medium px-4 py-1.5 rounded-full mb-6">
      ...
      <section className="py-8 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative h-[380px] rounded-3xl overflow-hidden shadow-xl">
            <Image
              src="https://images.unsplash.com/photo-1666214280557-f1b5022eb634?w=1400&q=80&auto=format&fit=crop"
              alt="Medical consultation with stem cell specialist Malaysia"
              fill
              className="object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-teal-900/70 to-transparent" />
            <div className="absolute bottom-6 left-8 text-white">
              <p className="text-sm font-semibold uppercase tracking-wider text-teal-300">Free Consultation</p>
              <p className="text-2xl font-bold">Speak Directly with a Specialist</p>
            </div>
          </div>
        </div>
      </section>
